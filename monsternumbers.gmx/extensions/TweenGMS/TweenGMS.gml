...
/*
    TweenNull();
    Returns a null tween which can safely be called
*/
...
TweenSetUseSeconds(TGMS_simple_x, SharedTweener().useSimpleDeltaTweens);
TweenSetUseSeconds(TGMS_simple_y, SharedTweener().useSimpleDeltaTweens);
...
TweenSetUseSeconds(TGMS_simple_fade, SharedTweener().useSimpleDeltaTweens);
...
TweenSetUseSeconds(TGMS_simple_xscale, SharedTweener().useSimpleDeltaTweens);
TweenSetUseSeconds(TGMS_simple_yscale, SharedTweener().useSimpleDeltaTweens);
...
TweenSetUseSeconds(TGMS_simple_turn, SharedTweener().useSimpleDeltaTweens);
...
TweenSetUseSeconds(TGMS_simple_rotate, SharedTweener().useSimpleDeltaTweens);
...
TweenSetUseSeconds(TGMS_simple_image_cycle, SharedTweener().useSimpleDeltaTweens);
...
TweenSetUseSeconds(TGMS_simple_speed_ramp, SharedTweener().useSimpleDeltaTweens);
...
TweenSetUseSeconds(TGMS_simple_hspeed_ramp, SharedTweener().useSimpleDeltaTweens);
TweenSetUseSeconds(TGMS_simple_vspeed_ramp, SharedTweener().useSimpleDeltaTweens);
...
#define TweenGetUseSeconds
/*
    TweenGetUseSeconds(tween);
*/
...
#define TweenSetUseSeconds
/*
    TweenSetUseSeconds(tween, bool)
*/
